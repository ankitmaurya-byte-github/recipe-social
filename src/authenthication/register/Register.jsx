  ...
  const handelLogin = async () => {
    ...
    try {
      ...
      await updateProfile(res.user, {
        ...
        email,
        photoURL:
          "https://i.pinimg.com/564x/ac/fd/47/acfd47a5e4fa3dce75136fd24c7b8600.jpg",
      });
      ...
      {!loading ? (
        <section>
          ...
          <div class="login-form">
            <h4 className={`${notfill && username === "" ? "red" : ""}`}>
              Username
            </h4>
            <div
              class={`username-input ${notfill && username == "" ? "red" : ""}`}
            >
            ...
            <h4 className={`${err || (notfill && email == "") ? "red" : ""}`}>
              Email
            </h4>
            <div
              class={`username-input ${
                err || (notfill && email == "") ? "red" : ""
              }`}
            >
              <i class="fas fa-user"></i>
              <input
