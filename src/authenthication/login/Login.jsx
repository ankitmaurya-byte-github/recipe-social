  ...
  const handellogin=async()=>{
      ...
      if(username.includes('@')){
        ...
        try{
          ...
          await signInWithEmailAndPassword(auth, doc.docs[0].data().email, password)
          navigate('/')
...
<section>
  ...
  <div class="login-form">
    <h4 className={`${wrongpassword || (notfill && username=='')?'red':''}`}>Username</h4>
    <div class={`username-input ${wrongpassword || (notfill && username=='')?'red':''}`}>
